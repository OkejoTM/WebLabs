import { dispatchRemoveGame, dispatchToggleGameStatus, dispatchRemoveAllGames } from "./events.js";
...
export function renderGamesList(gamesList) {
    ...
    <div class="games-list">
        <div class="filters-block">
            <form class="filters-form" method="post">
                ...
                <button type="button" class="btn btn-danger" id="remove-all-games-button">Удалить все игры</button>
            </form>
        </div>
    ...
    const removeAllButton = page.querySelector('#remove-all-games-button');
    removeAllButton.addEventListener('click', () => {
        const confirmation = confirm("Вы уверены, что хотите удалить все игры?");
        if (confirmation) {            
           eval(dispatchRemoveAllGames());
        }
    });
